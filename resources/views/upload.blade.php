...
@section('content')
<div class="container mx-auto p-4" style="padding-top: 5rem; padding-bottom: 5rem;">
    ...
    <div class="flex justify-center">
        <form id="upload-form" action="{{ route('upload') }}" method="POST" enctype="multipart/form-data" class="w-full max-w-lg bg-white shadow-md rounded px-8 pt-6 pb-8">
            @csrf
            @if (session('message'))
    ...
    document.getElementById('upload-button').addEventListener('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    title: 'Mengunggah...',
                    text: 'Harap tunggu sementara file Anda sedang diunggah.',
